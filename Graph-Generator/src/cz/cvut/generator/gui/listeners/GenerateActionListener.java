...
public class GenerateActionListener implements ActionListener{
    ...
    public void actionPerformed(ActionEvent e) {
        JTextArea ta = (JTextArea)Components.component.get("LogTextArea");
        JButton generateButton = (JButton)Components.component.get("generateButton");
        JButton stopButton = (JButton)Components.component.get("stopButton");
        ...
        if(fileName.compareTo("") == 0 || dir.compareTo("") == 0){
        ...
        for(Edge edge: graf.getEdges()) System.out.println(edge);
        System.out.println("path: " + dir + File.separatorChar + fileName);
        OutputParser op = new OutputParser(g, outputFormat, dir + fileName);
        try {
            op.generateOutput();
